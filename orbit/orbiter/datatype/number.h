...
namespace orbiter::datatype {
     ...
     */
    bool NumberTypeSetup(Context *ctx, TypeInfo *self);

    /**
     * @brief Creates a new Number object with an integer value.
     *
     * @param ctx Pointer to the context in which the number is being created.
     * @param value The integer value to initialize the Number object with.
     * @return A handle to the newly created Number object.
     */
    HNumber IntNew(const Context *ctx, IntegerUnderlying value);
     ...
     * @return A handle to the newly created Number object.
     */
    HNumber IntNew(const Context *ctx, const char *string, int base);
     ...
     * @return A handle to the newly created Number object.
     */
    HNumber UIntNew(const Context *ctx, UIntegerUnderlying value);
     ...
     * @return A handle to the newly created Number object.
     */
    HNumber UIntNew(const Context *ctx, const char *string, int base);
     ...
     */
    TypeInfo *NumberTypeInit(Context *ctx);
}
